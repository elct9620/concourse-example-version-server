...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { hp: @monster.hp, mp: @monster.mp, name: @monster.name, version_id: @monster.version_id } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { hp: @monster.hp, mp: @monster.mp, name: @monster.name, version_id: @monster.version_id } }
