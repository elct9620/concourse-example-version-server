...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { description: @version.description, major: @version.major, minior: @version.minior } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { description: @version.description, major: @version.major, minior: @version.minior } }
